...
EOF
	...
	vendor_id=$(lsusb | awk '/Quectel Wireless Solutions Co., Ltd. EC25 LTE modem/ {print $6}' | cut -d ":" -f 1)
	product_id=$(lsusb | awk '/Quectel Wireless Solutions Co., Ltd. EC25 LTE modem/ {print $6}' | cut -d ":" -f 2)
